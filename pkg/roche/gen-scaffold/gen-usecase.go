...
func GenerateUsecase(structName string, targetStruct *ast.StructType, cnf *config.Config) {
	...
	defer file.JenniferToFile(usecaseFile, cnf.UsecaseDir + "/" + util.CamelToSnake(structName) + ".go")
	defer file.JenniferToFile(repositoryFile, cnf.DomainRepoDir + "/" + util.CamelToSnake(structName) + ".go")
